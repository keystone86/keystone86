...
module tb_rung6_mov_base_nodisp;
    ...
    initial begin
        ...
        run_unsupported_form(3, 8'h8B, 8'h04, 8'h0C, 8'h00, 8'h00, 8'h00,
                             "SIB r/m=100 index!=100", 1'b0);
        run_unsupported_form(4, 8'h8B, 8'h44, 8'h0C, 8'h00, 8'h00, 8'h00,
                             "mod=01 SIB index!=100 disp8", 1'b0);
        run_unsupported_form(6, 8'h8B, 8'h84, 8'h0C, 8'h00, 8'h00, 8'h00,
                             "mod=10 SIB index!=100 disp32", 1'b0);
